...
CREATE TABLE templates (
    template_id VARCHAR(50) NOT NULL AUTO_INCREMENT COMMENT '模板唯一标识',
    template_name VARCHAR(200) NOT NULL COMMENT '模板名称, 与存储文件夹名称一致',
    ...
    template_path VARCHAR(500) NOT NULL COMMENT '模板文件存储路径',
...
CREATE TABLE template_assets (
    asset_id VARCHAR(50) NOT NULL AUTO_INCREMENT COMMENT '素材唯一标识',
